package com.demo.mylibrary.ClircularProgress;
...
public class CircularProgressButton extends Button {
    ...
    private OnAnimationEndListener mProgressStateListener = new com.demo.mylibrary.ClircularProgress.OnAnimationEndListener() {
        @Override
    ...
    private OnAnimationEndListener mCompleteStateListener = new com.demo.mylibrary.ClircularProgress.OnAnimationEndListener() {
        @Override
        public void onAnimationEnd() {
            if (mIconComplete != 0) {
                setText(null);
    ...
    private OnAnimationEndListener mIdleStateListener = new com.demo.mylibrary.ClircularProgress.OnAnimationEndListener() {
        @Override
        public void onAnimationEnd() {
            removeIcon();
            setText(mIdleText);
    ...
    private OnAnimationEndListener mErrorStateListener = new com.demo.mylibrary.ClircularProgress.OnAnimationEndListener() {
        @Override
        public void onAnimationEnd() {
            if (mIconError != 0) {
                setText(null);
    ...
    private void morphProgressToIdle() {
        ...
        animation.setFromStrokeColor(mColorIndicator);
        animation.setToStrokeColor(getNormalColor(mIdleColorState));
        animation.setListener(new com.demo.mylibrary.ClircularProgress.OnAnimationEndListener() {
            @Override
            public void onAnimationEnd() {
                removeIcon();
                setText(mIdleText);
